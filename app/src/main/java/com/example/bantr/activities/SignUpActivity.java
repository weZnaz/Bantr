...
import com.example.bantr.databinding.ActivitySignUpBinding;
...
setListners();
    ...
    private void setListners(){
        binding.goToLogin.setOnClickListener(v ->getOnBackPressedDispatcher().onBackPressed());
