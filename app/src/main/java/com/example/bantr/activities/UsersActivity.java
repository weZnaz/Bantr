...
import com.example.bantr.adapters.UserAdapter;
import com.example.bantr.databinding.ActivityUsersBinding;
...
public class UsersActivity extends BaseActivity  implements UserListener {
    ...
    private void showErrorMessage(){
        binding.textErrorMessage.setText(String.format("No User avaiable"));
